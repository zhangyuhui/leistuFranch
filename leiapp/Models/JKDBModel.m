...
+ (NSArray *)findByCourseID:(int)courseID
{
    NSString *condition = [NSString stringWithFormat:@"WHERE %@=%d",courseid,courseID];
    return [self findByCriteria:condition];
}

+ (NSArray *)findByCourseID:(int)courseID LessonID:(int)lessonID
{
    NSString *condition = [NSString stringWithFormat:@"WHERE %@=%d and %@=%d",courseid,courseID,lessonid,lessonID];
    return [self findByCriteria:condition];
}

+ (NSArray *)findByCourseID:(int)courseID LessonID:(int)lessonID SectionID:(int)sectionID
{
    NSString *condition = [NSString stringWithFormat:@"WHERE %@=%d and %@=%d and %@=%d",courseid,courseID,lessonid,lessonID,sectionid,sectionID];
    return [self findByCriteria:condition];
}

+ (NSArray *)findByCourseID:(int)courseID LessonID:(int)lessonID SectionID:(int)sectionID PageID:(int)pageID
{
    NSString *condition = [NSString stringWithFormat:@"WHERE %@=%d and %@=%d and %@=%d and %@=%d",courseid,courseID,lessonid,lessonID,sectionid,sectionID,pageid,pageID];
    return [self findByCriteria:condition];
}
